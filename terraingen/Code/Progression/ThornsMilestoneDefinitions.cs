	...
	static List<ThornsJournalGoalDefinition> BuildAll()
	{
		...
		return new List<ThornsJournalGoalDefinition>
		{
			...
			J( ref order, "goal_drink_water", "Parched", ThornsJourneyCategory.Survival,
				"My throat is completely dry. I still have a canteen — or I can drink from any open water.",
				"Hold RMB on water to drink", ThornsMilestoneType.Event, "drink", 1, 60,
				autoPin: true ),
			ControlGoal( ref order, "goal_explore_controls", "Learn the Ropes", ThornsJourneyCategory.Survival,
				"I need to learn where everything is before the wilds swallow me.",
				"Open each menu shortcut once to finish this goal",
				60, "goal_drink_water", autoPin: true ),
			J( ref order, "goal_eat_food", "Empty Stomach", ThornsJourneyCategory.Survival,
				...
				"Hold RMB on food to eat", ThornsMilestoneType.Event, "eat_food", 1, 60,
				prereq: "goal_explore_controls", autoPin: true ),
			BareHandsGatherGoal( ref order, "goal_bare_hands_gather", "Rough Harvest", ThornsJourneyCategory.Survival,
				...
				50, "goal_eat_food", autoPin: true ),
			J( ref order, "goal_acquire_weapon", "Unarmed", ThornsJourneyCategory.Survival,

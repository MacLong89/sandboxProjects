...
public sealed class TerrainManager : Component
{
	...
	[Property]
	[Category( "LoadConfig" ), ShowIf( "LoadConfigFromFile", true )]
	...
	[Property]
	[Category( "Debug" ), ShowIf( "ConfigureMode", true ) ] 
	...
	[Property]
	[Category("Noise"), ShowIf("ConfigureMode", true), Range( 0, 5 ), Step( 1 )]

	public int SetResolution { get; set; }

	[Property]
	[Category("Noise"), ShowIf("ConfigureMode", true), Range( 32, 2048 ), Step( 1 )]
	public int SampleResolution { get; set; }

	[Property]
	[Category("Noise"), ShowIf("ConfigureMode", true)]
	...
	[Property]
	[Category("Noise"), ShowIf("ConfigureMode", true), Range(-100, 100 ), Step( 1 )]
	...
	[Property]
	[Category( "Noise" ), Range( 0, 2 ), Step( 1 ), ShowIf( "ConfigureMode", true ) ]
	public int Noise1Type { get; set; }

	[Property]
	[Category( "Noise" ), Range( 0, 5000 ), Step( 1 ), ShowIf( "ConfigureMode", true )]
	public int Noise1Seed { get; set; }
	
	[Property]
	[Category( "Noise" ), Range( 0, 10 ), Step( 1 ), ShowIf( "ConfigureMode", true )]
	public int Noise1Octave { get; set; }

	[Property]
	[Category("Noise"), Range(0, 10), Step(0.1f), ShowIf("ConfigureMode", true)]
	...
	[Property]
	[Category( "Noise" ), Range( 0, .25f ), Step( 0.001f ), ShowIf( "ConfigureMode", true ) ]
	...
	[Property]
	[Category( "ExportNoise" ), ShowIf( "ConfigureMode", true )]
	public bool ExportOptions { get; set; }

	[Property]
	[Category( "ExportNoise" ), ShowIf( "ExportOptions", true)]
	public bool ExportToConfigFileOptions { get; set; }

	[Property]
	[Category( "ExportNoise" ), ShowIf( "ExportToConfigFileOptions", true )]
	...
	[Property]
	[Category( "ExportNoise" ), ShowIf( "ExportAsHeightMapOptions", true )]

...
/// Client never chooses final hit direction; owner receives a separate visual kick only (see <see cref="ThornsPawnMovement.OwnerApplyMomentaryWeaponRecoil"/>).
/// </summary>
public static class ThornsWeaponRecoilSolve
{
	/// <summary>Global tuning on top of per-weapon <see cref="ThornsWeaponDefinitions.WeaponDefinition.RecoilPatternScaleDegrees"/> — scales authoritative kick and <see cref="ThornsWeaponDefinitions.WeaponDefinition.ClientVisualKickScale"/> together (melee skips this path).</summary>
	const float GlobalGunRecoilKickMul = 0.5f;

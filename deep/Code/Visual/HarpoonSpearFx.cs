...
public sealed class HarpoonSpearFx : Component
{
	...
	public static void Launch( Vector3 from, Vector3 to, Action onArrive )
	{
		...
		var tex = DeepPixelArt.HarpoonSpear();
		fx._renderer = DeepSprites.SpawnTexture( go, tex, 1f, name: "SpearSprite" );
		DeepPixelArt.ApplyWorldWidth( fx._renderer, fx.SpriteWorldLength, tex );
		fx.OrientToward( to );
	}

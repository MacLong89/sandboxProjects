...
public sealed class OxygenComponent : Component
{
	...
	public bool IsLow
	{
		get
		{
			var low = DeepGame.Instance?.Balance.LowOxygenFraction ?? BalanceConfig.Defaults.LowOxygenFraction;
	...
	public bool IsCritical
	{
		get
		{
			var crit = DeepGame.Instance?.Balance.CriticalOxygenFraction ?? BalanceConfig.Defaults.CriticalOxygenFraction;
	...
	{
		var max = DeepGame.Instance?.Balance.MaxOxygenSeconds ?? BalanceConfig.Defaults.MaxOxygenSeconds;
		MaxOxygen = max;

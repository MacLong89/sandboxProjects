...
/// Prefer reading <see cref="DeepGame.Balance"/> at runtime so upgrades can mutate values later.
/// </summary>
public static class GameConstants
{
	private static BalanceConfig B => DeepGame.Instance?.Balance ?? BalanceConfig.Defaults;

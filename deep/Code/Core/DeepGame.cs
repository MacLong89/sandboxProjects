...
/// </summary>
public sealed class DeepGame : Component
{
	public static DeepGame Instance { get; private set; }
	...
	public DeepGameStateMachine State { get; private set; }
	...
	protected override void OnAwake()
	{
		...
		State = new DeepGameStateMachine();
	...
	protected override void OnStart()
	{
		...
		DeepSaveSystem.TryLoad( Progression );
	...
	public void FailDive( DiveFailureReason reason = DiveFailureReason.OxygenDepleted )
	{
		...
		DeepSaveSystem.Save( Progression );

...
public sealed class DiverController : Component
{
	...
	public void BeginDive()
	{
		...
		UpdateDepthState( DeepDiveGame.Instance );
	...
	private void TickMovement( BalanceConfig balance )
	{
		...
		var tools = DeepDiveGame.Instance?.Tools;
	...
	private void TrySurfaceSuccess( DeepDiveGame game )
	{
		var bed = SeabedTerrain.Instance;
	...
	private void UpdateDepthState( DeepDiveGame game )
	{
	...
	private void BuildVisual()
	{
		...
		var renderer = DeepDiveSprites.SpawnDiver( GameObject );

...
public sealed class ToolSystem : Component
{
	...
	public float ScanRadius => 28f + (DeepDiveGame.Instance?.Balance.ScannerRangeBonus ?? 0f);
	...
	private void HandleHotbarInput( DeepDiveGame game )
	{
	...
	public bool TryUseSelected( DeepDiveGame game )
	{
		var def = Hotbar.SelectedTool;
	...
	private bool UseHarpoon( DeepDiveGame game )
	{
	...
	private bool TrySalvageLockedAtPoint( DeepDiveGame game, Vector3 clickWorld )
	{
		var diver = game.Diver;
		if ( diver is null ) return false;
	...
	private HazardContact PickHazardAtPoint( DeepDiveGame game, Vector3 clickWorld )
	{
	...
	private bool UseScanner( DeepDiveGame game )
	{
	...
	private bool UseCamera( DeepDiveGame game )
	{
		var diver = game.Diver;
		if ( diver is null ) return false;
	...
	private bool UseOxygen( DeepDiveGame game )
	{
		var o2 = game.Oxygen;
	...
	private bool UseDrone( DeepDiveGame game )
	{
	...
	private bool UseLure( DeepDiveGame game )
	{
	...
	private bool UseSub( DeepDiveGame game )
	{
	...
	private static int CountNearbyLoot( DeepDiveGame game, float radius )
	{
		var diver = game.Diver;
	...
	private static int CountNearbyThreats( DeepDiveGame game, float radius )
	{
		var diver = game.Diver;
		if ( diver is null ) return 0;
		var n = 0;
	...
	public IReadOnlyList<MinimapBlip> BuildMinimapBlips( DeepDiveGame game, float mapRadiusMeters = 40f )
	{

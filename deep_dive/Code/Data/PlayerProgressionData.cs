...
public sealed class PlayerProgressionData
{
	...
	public DeepDiveSaveData ToSaveData()
	{
		return new DeepDiveSaveData
		{
			Version = DeepDiveSaveData.CurrentVersion,
	...
	public bool ApplySaveData( DeepDiveSaveData data )
	{
		...
		{
			ResetToNewGame();
			Log.Info( "[DeepDive] Migrated save to v3 — progression reset for buy-to-unlock loadout." );
			return true;
		}

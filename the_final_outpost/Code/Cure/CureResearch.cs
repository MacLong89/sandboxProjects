...
public static class CureResearch
{
	public static readonly IReadOnlyList<CureResearchTierDef> Tiers = new List<CureResearchTierDef>
	{
		new()
		{
			...
			LabPointsRequired = 15, ScrapCost = 80, WoodCost = 20, StoneCost = 15, WaterCost = 10, SpecimensCost = 0,
			MinSeason = 1
		},
		new()
		{
			Tier = 2, Name = "Synthesis", Description = "Combine samples into viable compounds.",
			LabPointsRequired = 35, ScrapCost = 150, WoodCost = 30, StoneCost = 25, WaterCost = 20, SpecimensCost = 2,
			MinSeason = 3
		},
		new()
		{
			Tier = 3, Name = "Patient Zero", Description = "Isolate the source strain from expedition finds.",
			LabPointsRequired = 60, ScrapCost = 220, WoodCost = 40, StoneCost = 35, WaterCost = 30, SpecimensCost = 5,
			MinSeason = 5
		},
		new()
		{
			Tier = 4, Name = "The Cure", Description = "Finalize and deploy the antidote.",
			LabPointsRequired = 90, ScrapCost = 300, WoodCost = 50, StoneCost = 45, WaterCost = 40, SpecimensCost = 8,
			MinSeason = 7
		}
	};
	...
	public static void ApplySeasonLabBonus( GameCore core )
	{
		...
		core.Save.CureLabPoints += CureConstants.LabPointsPerSeasonBase * labs * TeamBonuses.ResearchRateMult( core );
	}
	...
	public static bool CanUnlockTier( GameCore core, int tier )
	{
		...
		if ( core.Resources.Get( ResourceKind.Water ) < def.WaterCost * mult ) return false;
	...
	public static bool TryUnlockTier( GameCore core, int tier )
	{
		...
		core.Resources.TrySpend( ResourceKind.Water, def.WaterCost * mult );
